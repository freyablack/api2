...
async function fetchSwitch(){
    ...
    document.getElementById("Emblemabout").innerText = fireEmblem3housesdata.description
    document.getElementById("Emblemimg1").src = fireEmblem3housesdata.background_image
    document.getElementById("Emblemimg2").src = fireEmblem3housesdata.background_image_additional
    document.getElementById("Emblemtitle").innerText = fireEmblem3housesdata.name
    document.getElementById("Emblemdev").innerText = fireEmblem3housesdata.developers[0].name
    ...
    console.log(fireEmblem3housesdata)
}
